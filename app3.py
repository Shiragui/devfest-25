...
# st.image(logo_path, width=50)  # Set the width to 50 pixels
# st.markdown("<h1 class='custom-title'>Let's eat!</h1>", unsafe_allow_html=True)

# st.markdown(
#     "<h1 style='font-size: 60px; color: #FF4500; font-family: Arial, sans-serif; text-align: center; margin-top: 20px; margin-bottom: 10px; padding: 5px; background-color: rgba(255, 255, 255, 0.8);'>Let's eat!</h1>",
